        ...
        this.$posts.innerHTML = this.posts
            ...
            <div class="header">
              <div class="profile-area">
                <div class="post-pic">
                  <img
                    alt="atlehang's profile picture"
                    class="_6q-tv"
            ...
            <div class="body">
              <img
                alt="Photo by Atlehang on Janaury 1, 2023. Image contain flowers."
                class="FFVAD"
                decoding="auto"
                sizes="614px"
                src="${post.image}"
            ...
            <div class="footer">
              ...
              <span class="comment">
                <span class="caption-username"><b>siya</b></span>
                <span class="caption-text">Thank you</span>
              </span>
              <span class="comment">
                <span class="caption-username"><b>mbali</b></span>
